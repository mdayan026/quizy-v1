...
export default function QuestionsNavbar ({ changueCurrent }) {
	...
	function buttonBg (i) {
		...
		if (questions[i].userAnswer === 2) bg = 'bg-[#1404f6] !text-white'
